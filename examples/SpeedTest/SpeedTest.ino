...
SSD1351_t3 disp = SSD1351_t3(TFT_CS, TFT_DC, TFT_MOSI, TFT_SCLK, TFT_RST);
...
#define SETCOLOR(c) disp.setTextColor(c, bg ? SSD1351_BLACK : c);
...
void tftPrintTest(bool bg)
{
	...
	disp.fillScreen(SSD1351_BLACK);
	disp.setCursor(0, 30);
	SETCOLOR(SSD1351_RED);
	disp.setTextSize(1);
	disp.println("Hello World!");
	SETCOLOR(SSD1351_YELLOW);
	disp.setTextSize(2);
	disp.println("Hello World!");
	SETCOLOR(SSD1351_GREEN);
	disp.setTextSize(3);
	disp.println("Hello World!");
	SETCOLOR(SSD1351_BLUE);
	disp.setTextSize(4);
	disp.print(1234.567);

	disp.setCursor(0, 0);
	disp.fillScreen(SSD1351_BLACK);
	SETCOLOR(SSD1351_WHITE);
	disp.setTextSize(0);
	disp.println("Hello World!");
	disp.setTextSize(1);
	SETCOLOR(SSD1351_GREEN);
...
void mediabuttons()
{
	// play
	disp.fillScreen(SSD1351_BLACK);
	disp.fillRoundRect(25, 10, 78, 60, 8, SSD1351_WHITE);
	disp.fillTriangle(42, 20, 42, 60, 90, 40, SSD1351_RED);

	// pause
	disp.fillRoundRect(25, 90, 78, 60, 8, SSD1351_WHITE);
	disp.fillRoundRect(39, 98, 20, 45, 5, SSD1351_GREEN);
	disp.fillRoundRect(69, 98, 20, 45, 5, SSD1351_GREEN);

	// play color
	disp.fillTriangle(42, 20, 42, 60, 90, 40, SSD1351_BLUE);

	// pause color
	disp.fillRoundRect(39, 98, 20, 45, 5, SSD1351_RED);
	disp.fillRoundRect(69, 98, 20, 45, 5, SSD1351_RED);
	// play color
	disp.fillTriangle(42, 20, 42, 60, 90, 40, SSD1351_GREEN);
}
...
void setup()
{
	...
	disp.fillScreen(SSD1351_BLACK);
	t[n++] = millis();
	testdrawtext("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur adipiscing ante sed nibh tincidunt feugiat. Maecenas enim massa, fringilla sed malesuada et, malesuada sit amet turpis. Sed porttitor neque ut ante pretium vitae malesuada nunc bibendum. Nullam aliquet ultrices massa eu hendrerit. Ut sed nisi lorem. In vestibulum purus a tortor imperdiet posuere. ", SSD1351_WHITE, SSD1351_WHITE);
	t[n++] = millis();
	tftPrintTest(false);
	t[n++] = millis();
	testdrawtext("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur adipiscing ante sed nibh tincidunt feugiat. Maecenas enim massa, fringilla sed malesuada et, malesuada sit amet turpis. Sed porttitor neque ut ante pretium vitae malesuada nunc bibendum. Nullam aliquet ultrices massa eu hendrerit. Ut sed nisi lorem. In vestibulum purus a tortor imperdiet posuere. ", SSD1351_WHITE, SSD1351_BLACK);
	t[n++] = millis();
	tftPrintTest(true);
	t[n++] = millis();
